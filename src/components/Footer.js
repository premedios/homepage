                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            <p className=" h5 mb-4 font-weight-light">About Me</p>
                            <p className="font-weight-light about-text">
                                iOS and Web developer with over 20 years professional development experience. Hobbies
                                include: AI, Car Tuning, World of Warcraft, Bodybuilding and Cinema.
                            </p>
                        </div>
                        <div className="col-md-6">
                            ...
                            <ul className="nav social">
                                <li className="nav-item">
                                    <a
                                        href="https://www.facebook.com/pedroremedios"
                                        target="_blank"
                                ...
                                <li className="nav-item">
                                    <a
                                        href="https://www.github.com/premedios"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="nav-link">
                                ...
                                <li className="nav-item">
                                    <a
                                        href="https://www.twitter.com/prmobiledev"
                                        rel="noopener noreferrer"
                                        className="nav-link">
